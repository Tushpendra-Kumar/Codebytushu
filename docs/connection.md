...
| Add to Cart | `/courses/details.php` | `POST /api/cart/add.php` |
| View Cart | `/cart/index.php` | `GET /api/cart/view.php` |
| Checkout | `/checkout/index.php` | `POST /api/checkout/submit.php` |
