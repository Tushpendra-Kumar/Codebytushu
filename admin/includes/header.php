  ...
  <div class="header-right">
    ...
    <div class="header-dropdown-wrap">
      ...
      <div class="profile-dropdown" id="profileDropdown" role="menu">
        ...
        <a href="<?= SITE_URL ?>/user/dashboard.php?tab=profile" onclick="window.location.href='<?= SITE_URL ?>/user/dashboard.php?tab=profile'; return true;" class="profile-menu-item" role="menuitem">
          <span class="profile-menu-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
          </span>
          My Profile
        </a>
        <a href="<?= SITE_URL ?>/user/dashboard.php?tab=settings" onclick="window.location.href='<?= SITE_URL ?>/user/dashboard.php?tab=settings'; return true;" class="profile-menu-item" role="menuitem">
          <span class="profile-menu-icon">
